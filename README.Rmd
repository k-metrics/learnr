...
Name    | Version        | Memo
--------|----------------|---------------------------------------------
R       | N/A            | `learnr`パッケージの動作環境を満たすこと^1^
...
　  
不明点は [データ分析勉強 <i class="fa fa-external-link"></i>](https://sites.google.com/site/kantometrics/home){target="_blank" title="Google site"} まで、または、本リポジトリのissues にてお問い合わせください。